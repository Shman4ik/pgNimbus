...
var scenarios = new (string Name, Func<Window> Build)[]
{
    ...
    ("activity-window-empty", Scenarios.ActivityEmpty),
    ("database-overview-window", Scenarios.DatabaseOverview),
    ("database-overview-window-loading", Scenarios.DatabaseOverviewLoading),
    ("database-overview-window-empty", Scenarios.DatabaseOverviewEmpty),
