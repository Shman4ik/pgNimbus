...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        // The schema tree (drag-to-editor source, double-tap-to-browse, context
        // menus) lives in SchemaTreePanel now; the editor stays the drop target.
    ...
    // --- Schema-tree drop into the editor ---------------------------------
    // The drag *source* (arming, threshold, identifier text) lives in
    // SchemaTreePanel; the editor stays the drop target below.
